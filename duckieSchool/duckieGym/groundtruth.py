...
from logger import Logger, SteeringToWheelVelWrapper
...
class DataGenerator:
    ...
    def pure_pursuite(self, env) -> List[float]:
        ...
        # print(f"cpoint: {closest_point}, ctangent: {closest_tangent}")
        iterations = 0
...
if __name__ == "__main__":
    ...
    if args.env_name is None:
        ...
        env = DuckietownEnv(
            ...
            distortion=args.distortion,
            accept_start_angle_deg=4,
            randomize_maps_on_reset=args.random_map
        )
    else:
